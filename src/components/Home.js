...
const Home = () => {
  ...
  return (
    <>
      ...
      <section id='WhyCockrow' className='text-gray-600 body-font'>
        ...
        <div className='container mx-auto flex px-5 py-6 md:flex-row flex-col items-center'>
          ...
          <div className='md:w-2/5 w-5/6 items-center '>
            <a href='' className='video-play' data-video-id='sRy5dJg0k-8'>
              <img
      ...
      <section>
        <div id='process' className='container mt-20 bg-white mx-auto'>
          <div className='howunderline  flex justify-end pr-48 pt-8 '>
            <h2
              className='text-gray-900  how  focus:outline-none cursor-pointer rounded text-5xl'
              style={{ fontFamily: 'Raleway', fontWeight: 'bold' }}
            >
              {' '}
              How it works{' '}
          ...
          <div className='container bg-white  mx-auto flex px-5 rounded py-4 md:flex-row flex-col items-center'>
            ...
            <div
              className='lg:flex-grow md:w-2/3  flex flex-col  items-center text-center'
              style={{ fontFamily: 'Raleway', fontWeight: 600 }}
            >
              <div
                className=' py-0 mx-auto flex flex-wrap'
                style={{
                  fontFamily: 'Raleway',
                  fontWeight: 600,
                  padding: 0,
      ...
      <div className='tabs text-black '>
        ...
        <div className='tab-body'>
          <div className='active'>
            <h1
              className='text-center mr-16 mt-6 mb-3 text-4xl'
              style={{
                fontFamily: 'Raleway',
                fontWeight: 800,
                color: '#210070',
            ...
            <h2
              className='text-center mr-16 -mb-6 text-xl'
              style={{ fontFamily: 'Raleway', fontWeight: 600 }}
            >
          ...
          <div>
            <h1
              className='text-center mb-3 mr-16 mt-6 text-4xl'
              style={{
                fontFamily: 'Raleway',
                fontWeight: 'bold',
                color: '#210070',
            ...
            <h2
              className='text-center mb-5 mr-16 text-xl'
              style={{ fontFamily: 'Raleway', fontWeight: 'bold' }}
            >
              Your are just one step away to reach us
            </h2>
