  ...
  return (
    <div className='join-us'>
      ...
      <section className='text-gray-600 body-font'>
        <div className='container head px-5 py-10 mx-auto'>
          ...
          <div className='flex flex-row  -mb-10 -mt-20'>
            ...
            <div
              className='head3 md:w-1/2 sm:mb-0 mb-6'
              style={{ marginLeft: '-15%' }}
            >
              <div className='h-80 overflow-hidden'>
                <img
      ...
      <div className='contb  flex justify-center'>
        <button
          className='contact2 ml-0  mt-8 py-2 px-6  rounded text-xl'
      ...
      <h1
        style={{ textAlign: 'center', fontFamily: 'raleway', fontWeight: 500 }}
      ...
      <div className='contb  flex justify-center'>
        <button
          ...
          style={{ fontFamily: 'raleway', fontWeight: 'bold' }}
        >
          <a href='index.html#contact'>Book an event</a>
        </button>
      </div>
